...
const Hero = () => {
  ...
  if (loading) {
    return (
      <div className="relative w-full bg-gray-100 flex items-center justify-center h-64 md:h-80 lg:h-96">
  ...
  return (
    <div
      className="relative overflow-hidden h-64 md:h-80 lg:h-96"
