          ...
          {categories.map((category) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 md:p-6 lg:p-8 bg-gradient-to-t from-black/80 to-transparent">
                {/* Title */}
                <h3 className="text-[10px] sm:text-xs md:text-sm lg:text-lg xl:text-xl font-light text-white mb-1 sm:mb-2 md:mb-3 tracking-wide"
                    style={{
                ...
                {/* Shop Link - Minimal */}
                <div className="flex items-center text-white text-[7px] sm:text-[8px] md:text-[9px] lg:text-[10px] font-light tracking-widest uppercase opacity-80 group-hover:opacity-100 transition-opacity duration-300">
