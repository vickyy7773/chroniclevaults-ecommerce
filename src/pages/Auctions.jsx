              ...
              <div
                ...
                onClick={() => {
                  ...
                  if (auction.status === 'Ended') {
                    ...
                    // For active and upcoming auctions, go to catalog
                    navigate(`/auction/${auction._id}/catalog`);
                  }
                }}
                className="rounded-lg shadow-md overflow-hidden transition-all cursor-pointer hover:shadow-xl transform hover:-translate-y-1"
              >
