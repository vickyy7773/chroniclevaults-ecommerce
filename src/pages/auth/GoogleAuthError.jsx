...
const GoogleAuthError = () => {
  ...
  const errorMessage = searchParams.get('message') || 'Something went wrong with Google Sign-In';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-8 text-center">
        ...
        <div className="space-y-3">
          <Link
            to="/"
            className="block w-full bg-amber-600 hover:bg-amber-700 text-white py-3 rounded-lg font-medium transition-colors"
          >
            Try Again
          </Link>
          <Link
