          ...
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
            <div className="text-center text-white px-3">
              ...
              {category.description && (
                <p className="text-xs md:text-lg lg:text-xl xl:text-2xl">{category.description}</p>
              )}
            </div>
          </div>
        </div>
      ) : (
        <div className="bg-white border-b border-slate-200 py-6 md:py-12 lg:py-16">
          <div className="container mx-auto px-3 md:px-4 text-center">
            <h1 className="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-2 md:mb-4 text-slate-900">
              {category?.name || categoryName} Collection
            </h1>
            <p className="text-sm md:text-lg lg:text-xl text-slate-600">
        ...
        <div className="flex gap-3 md:gap-6">
          ...
          <div className="flex-1">
            ...
            {searchParams.get('sub') && (
              <div className="mb-3 md:mb-4 p-2 md:p-3 bg-amber-50 border border-amber-200 rounded-lg">
            ...
            <div className="lg:hidden mb-3 md:mb-4">
              <button
                ...
                className="btn-primary w-full py-2 md:py-3 flex items-center justify-center gap-2 text-sm md:text-base"
              >
            ...
            <div className="flex items-center justify-between mb-3 md:mb-6 gap-2">
              ...
              <select
                ...
                className="px-2 md:px-4 py-1.5 md:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 font-medium text-[10px] md:text-sm"
              >
            ...
            {filteredProducts.length === 0 ? (
              <div className="text-center py-8 md:py-16">
                ...
                <h3 className="text-lg md:text-2xl font-bold text-gray-900 mb-1 md:mb-2">No products found</h3>
                <p className="text-sm md:text-base text-gray-600">Try adjusting your filters or check back later for new items.</p>
              </div>
            ) : (
                  ...
                  >
                    ...
                    >
                      ...
                      {product.originalPrice > product.price && (
                        <div className="absolute top-1.5 md:top-2 right-1.5 md:right-2 bg-gradient-to-r from-red-500 to-red-600 text-white px-1.5 md:px-2 py-0.5 md:py-1 rounded-full text-[9px] md:text-xs font-medium shadow-lg">
                          SALE
                        </div>
                      )}
                      {product.rarity && (
                        <div className="absolute top-1.5 md:top-2 left-1.5 md:left-2 bg-slate-900/90 backdrop-blur-sm text-white px-1.5 md:px-2 py-0.5 md:py-1 rounded-full text-[9px] md:text-xs font-normal">
                          {product.rarity}
                        </div>
                      )}
                      <button
                        ...
                        className="absolute bottom-1.5 md:bottom-2 right-1.5 md:right-2 bg-white hover:bg-slate-900 text-slate-900 hover:text-white p-1.5 md:p-2 rounded-full shadow-lg transition-all duration-300 opacity-0 group-hover:opacity-100 hover:scale-110"
            ...
            {filteredProducts.length > itemsPerPage && (
              <div className="mt-4 md:mt-8 flex justify-center items-center gap-1.5 md:gap-2">
                <button
                  onClick={() => setCurrentPage(prev => Math.max(prev - 1, 1))}
                  disabled={currentPage === 1}
                  className="px-2 md:px-4 py-1.5 md:py-2 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all text-[10px] md:text-sm"
                >
                    ...
                    if (
                      ...
                      return (
                        <button
                          ...
                          className={`px-2.5 md:px-4 py-1.5 md:py-2 rounded-lg transition-all text-[10px] md:text-sm ${
                            currentPage === pageNum
                      ...
                      return <span key={pageNum} className="px-1 md:px-2 py-1.5 md:py-2 text-[10px] md:text-sm">...</span>;
                    }
                    return null;
                  })}
                </div>
