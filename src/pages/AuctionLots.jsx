  ...
  const handlePlaceBid = async (lotNumber) => {
    ...
    try {
      ...
      if (amount > minBid) {
        ...
        // Place bid at the amount user entered (NOT at minimum increment)
        // The backend will handle auto-bidding if there's a higher reserve
        actualBid = amount;
        console.log(`🎯 PROXY BID: Placing bid at ₹${actualBid.toLocaleString()}, Max reserve ₹${maxBid.toLocaleString()}`);
      }
