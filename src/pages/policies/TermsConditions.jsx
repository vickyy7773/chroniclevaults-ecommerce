      ...
      <div className="bg-gradient-to-br from-amber-50 to-white py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center mb-6">
            <FileText className="w-12 h-12 text-amber-600 mr-4" />
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              By accessing and placing an order with Chronicle vaults, you confirm that you are in agreement with and bound by the terms of service contained in the Terms & Conditions outlined below. These terms apply to the entire website and any email or other type of communication between you and Chronicle vaults.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
              Under no circumstances shall Chronicle vaults team be liable for any direct, indirect, special, incidental or consequential damages, including, but not limited to, loss of data or profit, arising out of the use, or the inability to use, the materials on this site, even if Chronicle vaults team or an authorized representative has been advised of the possibility of such damages. If your use of materials from this site results in the need for servicing, repair or correction of equipment or data, you assume any costs thereof.
            </p>
            <p className="text-gray-700 leading-relaxed">
              Chronicle vaults will not be responsible for any outcome that may occur during the course of usage of our resources. We reserve the rights to change prices and revise the resources usage policy in any moment.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Chronicle vaults grants you a revocable, non-exclusive, non-transferable, limited license to download, install and use our service strictly in accordance with the terms of this Agreement.
            </p>
            <p className="text-gray-700 leading-relaxed mb-4">
              These Terms & Conditions are a contract between you and Chronicle vaults (referred to in these Terms & Conditions as "Chronicle vaults", "us", "we" or "our"), the provider of the Chronicle vaults website and the services accessible from the Chronicle vaults website (which are collectively referred to in these Terms & Conditions as the "Chronicle vaults Service").
            </p>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">For this Terms & Conditions:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-3">
              ...
              <li><strong>Company:</strong> when this policy mentions "Company," "we," "us," or "our," it refers to Chronicle vaults, 16/189, Netajinagar, Meghaninagar, Ahmedabad-380016, Gujarat that is responsible for your information under this Privacy Policy.</li>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">You agree not to, and you will not permit others to:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              ...
              <li>Remove, alter or obscure any proprietary notice (including any notice of copyright or trademark) of Chronicle vaults or its affiliates, partners, suppliers or the licensors of the service.</li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed">
              This section applies to any dispute EXCEPT IT DOESN'T INCLUDE A DISPUTE RELATING TO CLAIMS FOR INJUNCTIVE OR EQUITABLE RELIEF REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR CHRONICLE VAULTS'S INTELLECTUAL PROPERTY RIGHTS. The term "dispute" means any dispute, action, or other controversy between you and us concerning the Services or this agreement, whether in contract, warranty, tort, statute, regulation, ordinance, or any other legal or equitable basis. "Dispute" will be given the broadest possible meaning allowable under law.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <p className="text-gray-800 mb-2">
                <strong>Email:</strong> <a href="mailto:chroniclevaults@gmail.com" className="text-amber-600 hover:text-amber-700">chroniclevaults@gmail.com</a>
              </p>
              <p className="text-gray-800 mb-2">
                <strong>Phone:</strong> <a href="tel:+918460849878" className="text-amber-600 hover:text-amber-700">+918460849878</a>
              </p>
              <p className="text-gray-800 mb-2">
                <strong>Address:</strong> 16/189, Netajinagar, Meghaninagar, Ahmedabad-380016, Gujarat
              </p>
              <p className="text-gray-800">
                <strong>Website:</strong> <a href="https://chroniclevaults.com/contact-us" className="text-amber-600 hover:text-amber-700">https://chroniclevaults.com/contact-us</a>
              </p>
            </div>
          </section>
        </div>
